...
<f:subview id="svSecondaryNavigation">
   <f:subview id="svScript">
	...
	<h:form id="frmSecondaryNavigation"
	  ...
	  <h:commandLink action="catalog.publication.manageGeooperator"
	    id="publicationAddGeooperator"
	    value="#{gptMsg['catalog.publication.manageGeooperator.subMenuCaption']}"
	    styleClass="#{PageContext.menuStyleMap['catalog.publication.manageGeooperator']}"/>  
