...
<jsp:useBean id="Splitter" class="de.tudresden.gis.search.Splitter" scope="request"></jsp:useBean>
		...
		<h:column id="metadataColumn">
			<h:panelGrid id="_metadataMainRecordTable" columns="1"
				...
				<h:panelGroup id="recContent" style="#{SearchController.expandResultContentStyle}">
					...
					<h:graphicImage id="iconPlatform"
						value="#{Splitter.getPlatform(record['abstract'], true)}"
						height="36"
						width="36"
						styleClass="resultsThumbnail" />
					<h:graphicImage id="iconContainertype"
						value="#{Splitter.getContainertype(record['abstract'], true)}"
						height="36"
						width="36"
						styleClass="resultsThumbnail" />
					Abstract: <h:outputText id="_txtAbstract" styleClass="resultsContent" value="#{Splitter.getAbstract(record['abstract'])}" />
					<br />
					Containertype: <h:outputText id="_txtContainertype" styleClass="resultsContent" value="#{Splitter.getContainertype(record['abstract'], false)}" />
					<br />
					Platform: <h:outputText id="_txtPlatform" styleClass="resultsContent" value="#{Splitter.getPlatform(record['abstract'], false)}" />
				</h:panelGroup>
