...
Exhibit.Database.l10n.sortLabels={"text":{ascending:"a - z",descending:"z - a"},"number":{ascending:"kleinstes zuerst",descending:"groesstes zuerst"},"date":{ascending:"fruehestes zuerst",descending:"spaetestes zuerst"},"boolean":{ascending:"falsch zuerst",descending:"wahr zuerst"},"item":{ascending:"a - z",descending:"z - a"}};
...
Exhibit.l10n.showJavascriptValidationMessage="Dieser Fehler wird detailliert nach dieser Nachricht erklaert.";
Exhibit.l10n.showJsonValidationMessage="Dieser Fehler wird detailliert nach dieser Nachricht erklaert.";
Exhibit.l10n.showJsonValidationFormMessage="Nach dieser Nachricht werden Sie zu einem Webservice weitergeleitet, mit dessen Hilfe Sie ihren Code ueberpruefen koennen.";
Exhibit.l10n.badJsonMessage=function(A,B){return"Die JSON Datei\n  "+A+"\nenthaelt Fehler =\n\n"+B;
};
Exhibit.l10n.failedToLoadDataFileMessage=function(A){return"Die Datei\n  "+A+"\nkann nicht gefunden werden. Bitte ueberpruefen Sie den Dateinamen.";
};
Exhibit.l10n.exportButtonLabel="Exportieren";
Exhibit.l10n.exportAllButtonLabel="Alles Exportieren";
Exhibit.l10n.exportDialogBoxCloseButtonLabel="Schliessen";
Exhibit.l10n.exportDialogBoxPrompt="Kopieren Sie diesen Code wie normalen Text in die Zwischenablage. Druecken Sie ESC um dieses Dialogfenster zu schliessen.";
Exhibit.l10n.focusDialogBoxCloseButtonLabel="Schliessen";
...
Exhibit.Formatter.l10n.shortMonths=["Jan","Feb","Maer","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"];
Exhibit.Formatter.l10n.months=["Januar","Februar","Maerz","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"];
...
}Exhibit.ViewPanel.l10n.createSelectViewActionTitle=function(A){return"Waehle Sicht "+A;
};
...
Exhibit.CollectionSummaryWidget.l10n.filteredResultsTemplate="<span class='%0' id='resultDescription'></span> gefiltert von urspruenglich <span id='originalCountSpan'>0</span> (<span id='resetActionLink'></span>)";
...
Exhibit.FacetUtilities.l10n.facetSelectOnlyActionTitle="Waehle nur %0 in Facette %1 aus";
Exhibit.FacetUtilities.l10n.facetClearSelectionsActionTitle="Loesche Auswahl in Facette %0";
Exhibit.FacetUtilities.l10n.facetTextSearchActionTitle="Textsuche %0";
Exhibit.FacetUtilities.l10n.facetClearTextSearchActionTitle="Textsuche zuruecksetzen";
...
return String.substitute("<a class='exhibit-action exhibit-views-unplottableCount' href='javascript:void' id='unplottableCountLink'>%0</a> von <class class='exhibit-views-totalCount'>%1</span> koennen nicht angezeigt werden.",[D==1?(D+" Ergebnis"):(D+" Ergebnisse"),B]);
};
