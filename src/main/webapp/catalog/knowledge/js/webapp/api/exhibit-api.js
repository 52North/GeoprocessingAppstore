...
//                Exhibit.locales.push(locale);
        ...
        if (useLocalResources) {
            Exhibit.urlPrefix = "./js/webapp/api/";
        }
        ...
        if (includeTimeline) {
            scriptURLs.push(useLocalResources ?
                "./js/webapp/extensions/time/time-extension.js" :
                "http://static.simile.mit.edu/exhibit/extensions-2.0/time/time-extension.js");
        }     
        
        includeMap = false; useLocalResources = true;
 
        if (includeMap) {
            scriptURLs.push(useLocalResources ?
                "./js/webapp/extensions/map/map-extension.js?service=openlayers" :
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
            "./js/ajax/api/simile-ajax-api.js?bundle=false" :
            //"js/ajax/api/simile-ajax-api.js?bundle=false" :
