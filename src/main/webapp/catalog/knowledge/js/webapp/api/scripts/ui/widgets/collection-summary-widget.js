...
Exhibit.CollectionSummaryWidget.prototype._initializeUI = function() {
    ...
    var onClearFilters = function(elmt, evt, target) {
        ...
        document.getElementById("noPrefGeodata").checked = false;
        document.getElementById("Raster").checked = false;
        document.getElementById("Vector").checked = false;
        document.getElementById("noPrefLegacy").checked = false;
        document.getElementById("GRASS").checked = false;
        document.getElementById("ArcGIS").checked = false;
        document.getElementById("noPrefPragmatic").checked = false;
        document.getElementById("Transport_route_planning").checked = false;
        document.getElementById("Modeling_paths").checked = false;
