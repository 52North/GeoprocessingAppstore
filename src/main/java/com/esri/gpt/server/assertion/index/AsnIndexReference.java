...
public class AsnIndexReference {
  ...
  /**
   * Makes an index adapter based upon the associated indexAdapterClass. without context
   * @return
   * @throws ClassNotFoundException
   * @throws InstantiationException
   * @throws IllegalAccessException
   */
  public AsnIndexAdapter makeIndexAdapterWithoutContext() //name change because of problems 
		    throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		    if (!this.getEnabled()) {
		      String msg = "The index is not enabled: "+this.getName();
		      throw new ConfigurationException(msg);
